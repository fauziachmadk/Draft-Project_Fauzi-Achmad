                ...
                <div class="card-body p-5">
                    <form action="/aspirasi/store" enctype="multipart/form-data" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="id" class="form-control bg-success text-light fw-bold" readonly
                                value="{{ $no }}">
                        </div>
                        <div class="mb-3">
    ...
    <div class="row justify-content-center">
        <div class="col-12 mb-3">
            <nav class="navbar navbar-expand-lg bg-light shadow border-bottom rounded-4 p-lg-3 p-sm-0 p-md-3">
                <div class="container">
                    <a class="navbar-brand fw-bold text-warning fs-3" href="/aspirasi">Lihat Pengaduan</a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 px-4  py-3">
                            ...
                            <div class="d-block">
                                ...
                                <img src="{{ url('img/' . $as->input_aspirasi->gambar) }}"
                                 width="100" height="70">
                            </div>
